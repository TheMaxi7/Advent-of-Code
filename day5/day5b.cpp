...
int main() {
    ...
    long long seed_lenght_value;;
    long long seed_start_value;
    istringstream tokenStream(seeds_string);
    while (tokenStream >> seed_start >> seed_lenght) {
        seed_start_value = std::stoll(seed_start);
        seed_lenght_value = std::stoll(seed_lenght);
        //cout << seed_start << endl;
        //cout << seed_lenght << endl;
        for (long long i = seed_start_value; i < seed_start_value + seed_lenght_value; i++) {
            seedValue = i;
